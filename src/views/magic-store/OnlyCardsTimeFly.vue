<template>
  <el-container class="app-container-row">
     <!-- 图片A（右上角） -->
     <img src="@/assets/layouts/magic-logo.png" alt="Image A" class="image-top-left">
...
<script>
import { ideaBackURL, ideaFrontURL} from './components-timefly/ideaLight'; 
import { emotionBackURL, emotionFrontURL} from './components-timefly/emotionSinger'; 
import { abilityBackURL, abilityFrontURL} from './components-timefly/abilityGift'; 
import { universeBackURL, universeFrontURL} from './components-timefly/universeDoor'; 
import { viewBackURL, viewFrontURL} from './components-timefly/view'; 
import { fightBackURL, fightFrontURL} from './components-timefly/fightLevel'; 
import { specialBackURL, specialFrontURL} from './components-timefly/specialMovie'; 
  ...
  data() {
    return {
      ...
      cards: [
        ...
        {type: 'emotion',frontImage: emotionBackURL, backImage: '' , flipped: false},
        {type: 'ability',frontImage: abilityBackURL, backImage: '' , flipped: false},
        {type: 'universe',frontImage: universeBackURL, backImage: '' , flipped: false},
        {type: 'view',frontImage: viewBackURL, backImage: '' , flipped: false},
        {type: 'fight',frontImage: fightBackURL, backImage: '' , flipped: false},
        {type: 'special',frontImage: specialBackURL, backImage: '' , flipped: false},
        {type: 'heart',frontImage: heartBackURL, backImage: '' , flipped: false},
        {type: 'share',frontImage: shareBackURL, backImage: '' , flipped: false},
        {type: 'feel',frontImage: feelBackURL, backImage: '' , flipped: false},
      ],
      dialogVisible: false,
      selectedCardImage: '',
    ...
    flipCard(card) {
      ...
      switch (card.type) {
        case 'idea':
          ...
          break;
        case 'emotion':
          frontImages = emotionFrontURL;
          break;
        case 'ability':
          frontImages = abilityFrontURL;
          break;
        case 'universe':
          frontImages = universeFrontURL;
          break;
        case 'view':
          frontImages = viewFrontURL;
          break;
        case 'fight':
          frontImages = fightFrontURL;
          break;
        case 'special':
          frontImages = specialFrontURL;
          break;
        case 'heart':
          frontImages = heartFrontURL;
          break;
        case 'share':
